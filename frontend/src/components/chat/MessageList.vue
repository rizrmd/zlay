<template>
  ...
  >
    ...
    <div class="max-w-2xl flex-1">
      <Card
        :class="message.role === 'user' ? 'bg-primary text-primary-foreground ml-auto' : 'bg-muted'"
      >
            ...
            >
              <div class="flex items-center space-x-2 text-sm mb-2">
                <div
                  ...
                  :class="getToolStatusColor(chatStore.getToolStatus(toolCall))"
                ></div>
              ...
              <div v-if="toolCall.function.arguments" class="text-xs text-muted-foreground mb-2">
                ...
                <pre class="mt-1 p-2 bg-background rounded border text-xs overflow-auto">{{
              ...
              <div v-if="toolCall.status === 'completed' && toolCall.result" class="text-xs">
                ...
                <pre
                  class="mt-1 p-2 bg-green-50 dark:bg-green-950/20 rounded border text-xs overflow-auto max-h-48"
                  >{{
              ...
              <div v-if="toolCall.status === 'failed' && toolCall.error" class="text-xs">
                ...
                <pre
                  class="mt-1 p-2 bg-red-50 dark:bg-red-950/20 rounded border text-xs overflow-auto"
                  >{{ toolCall.error }}</pre
                >
              </div>
            </div>
